...
const VoicesOfTrust = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Voices Of Trust - QuoreTex Technologies</title>
        <meta 
          name="description" 
        ...
        />
        <link rel="canonical" href="https://quore-tex.com/VoicesOfTrust" />
        {/* Open Graph */}
        ...
        <meta property="og:url" content="https://quore-tex.com/VoicesOfTrust" />
